...
//cut it from here along with CodingTest.h and CodingTest.cpp in the utility.cpp
//	string str_input;
//	cout << "Please enter sentence to check: " << endl;
//	getline (cin, str_input);
//	//cout << "Input String: " << str_input << endl;
	CodingTest coding;
//	//cout << "Ouput: " << coding.check_palindrome_sent (str_input) << endl;
//	if (coding.check_palindrome_sent (str_input)) {
...
//	string first;
//	string second;
//	cout << "Please enter words to check if they are anagrams:\nFirst: ";
//	cin >> first;
//	cout << endl << "Second: ";
//	cin >> second;
//	if (coding.check_anagram_words (first, second)) {
//		cout << "The words " << first <<" and " << second << " are anagrams. " << endl;
//	}
//	else {
//		cout << "The words " << first <<" and " << second << " are NOT anagrams. " << endl;
//	}

	string input_str_pal;
	//string output_max_pal;
	cout << "Program to search longest palindrome in a string\n" << "Please enter string: ";
	getline (cin, input_str_pal);
	auto output_max_pal = coding.greatest_pal_string (input_str_pal);
	cout << endl << "Longest palindrome in the given string is: " << output_max_pal << endl;
